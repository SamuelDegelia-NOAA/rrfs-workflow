...
valid_vals_DO_IODA_BUFR=("TRUE" "true" "YES" "yes" "FALSE" "false" "NO" "no")
valid_vals_DO_IODA_MRMS=("TRUE" "true" "YES" "yes" "FALSE" "false" "NO" "no")
valid_vals_DO_JEDIVAR=("TRUE" "true" "YES" "yes" "FALSE" "false" "NO" "no")
valid_vals_DA_SYSTEM=("GSI" "gsi" "JEDI" "jedi")
valid_vals_DO_DACOLD=("TRUE" "true" "YES" "yes" "FALSE" "false" "NO" "no")
valid_vals_DO_ARCHIVE_RETRO=("TRUE" "true" "YES" "yes" "FALSE" "false" "NO" "no")
valid_vals_DO_ENKF_ONLY=("TRUE" "true" "YES" "yes" "FALSE" "false" "NO" "no")
