...
EXPT_BASEDIR="/lfs/h2/emc/da/noscrub/$USER/rrfs-workflow_na3km/rrfs-workflow/expt_dirs/May2024_retro_enkf/$version"
EXPT_SUBDIR="rrfs_na_3km.enkf_jedi"
...
NUM_ENS_MEMBERS=30
JCB_CONFIG_ENKF_OBSERVER="rdas-atmosphere-templates-fv3_na3km_dbz_getkf_observer.yaml"
JCB_CONFIG_ENKF_SOLVER="rdas-atmosphere-templates-fv3_na3km_dbz_getkf_solver.yaml"
...
# retro period:
#DATE_FIRST_CYCL="20240527"
#DATE_LAST_CYCL="20240531"
#CYCL_HRS=( "00" "12" )
