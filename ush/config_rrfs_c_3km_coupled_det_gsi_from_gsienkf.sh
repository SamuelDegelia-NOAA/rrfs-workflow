...
EXPT_BASEDIR="/lfs/h2/emc/da/noscrub/$USER/rrfs-workflow_conus3km/rrfs-workflow/expt_dirs/May2024_retro_coupled_det_fromgsi/$version"
EXPT_SUBDIR="rrfs_conus_3km.coupled_det_fromgsi"
...
RRFSE_NWGES="/lfs/h2/emc/ptmp/$USER/May2024_retro/$version/rrfs_conus_3km.enkf_gsi"
