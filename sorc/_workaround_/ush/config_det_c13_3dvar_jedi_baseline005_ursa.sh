...
EXPT_SUBDIR="det_c13_3dvar_jedi_baseline005"
EXPT_BASEDIR="/scratch4/BMC/zrtrr/$USER/rrfs_expts/May2024_retro/$version/"
STMP="/scratch4/BMC/zrtrr/$USER/rrfs_expts/stmp/May2024_retro/$version/$EXPT_SUBDIR"
PTMP="/scratch4/BMC/zrtrr/$USER/rrfs_expts/ptmp/May2024_retro/$version/$EXPT_SUBDIR"
NWGES="/scratch4/BMC/zrtrr/$USER/rrfs_expts/ptmp/May2024_retro/$version/$EXPT_SUBDIR/nwges"
ARCHIVEDIR="/NCEPDEV/emc-meso/5year/$USER/RRFSv1/May2024_retro/$version/$EXPT_SUBDIR/"
...
RRFSE_NWGES="/scratch4/NCEPDEV/fv3-cam/runs_co13km/rrfs.v0.8.6/nwges_enkf"
