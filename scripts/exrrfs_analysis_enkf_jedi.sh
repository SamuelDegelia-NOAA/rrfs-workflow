...
#
  ...
  export OMP_NUM_THREADS=1 #${TPP_RUN_ENKF}
...
exit 0 #@@@ Stopping here to see if I can get this task going in the workflow. Then will continue coding up this task for JEDI.
